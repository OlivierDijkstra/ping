...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-link text-sm font-medium leading-5 text-gray-400 focus:outline-none focus:border-blue transition duration-150 ease-in-out'
